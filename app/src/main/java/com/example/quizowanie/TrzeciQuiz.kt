...
class TrzeciQuiz : AppCompatActivity() {
    ...
    private var questionSetsList3: List<Question>?=null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.drugi_quiz)
        ...
        questionSetsList3 = questionDb.questionSet3
        qCountTotal = 5 //questionSetsList!!.size

        shuffle(questionSetsList3!!)
    ...
    private fun showQuestion() {
        ...
        if (qCounter < qCountTotal) {
            currQuestion = questionSetsList3!![qCounter]
    ...
    override fun onBackPressed() {
        ...
        if (onBackPressedTime + 2000 > System.currentTimeMillis()) {
            ...
            Toast.makeText(this@TrzeciQuiz, "Kliknij jeszcze raz", Toast.LENGTH_SHORT).show()
        }
